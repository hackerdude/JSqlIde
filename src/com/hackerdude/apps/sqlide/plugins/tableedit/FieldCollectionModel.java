...
class FieldCollectionModel extends AbstractTableModel {
	...
	public static final String[] COLUMN_NAMES = {  "Field Name", "Type", "Length", "Null", "PK" };
	public static final Class[] COLUMN_CLASSES = { String.class, TableFieldType.class, Integer.class, Boolean.class, Boolean.class };
	...
	public void setValueAt( Object aValue, int row, int column ) {
		...
		switch (column) {
			case COL_FIELDNAME: itm.fieldName = value; break;
			case COL_TYPE: itm.fieldType = new TableFieldType(value); break;
			case COL_LENGTH: itm.fieldLen  = iValue; break;
			case COL_NULLALLOWED: itm.canBeNull = bValue; break;
			case COL_PK: itm.primaryKey = bValue; break;
		}
	}
	...
	public Object getValueAt( int row, int column ) {
		...
		TableField itm = (TableField)fields.get(row);
		switch (column) {
			case COL_FIELDNAME: result = itm.fieldName; break;
			case COL_TYPE: result = itm.fieldType; break;
			case COL_LENGTH: result = itm.fieldLen; break;
			case COL_NULLALLOWED: result = itm.canBeNull; break;
			case COL_PK: result = itm.primaryKey; break;
		}
		return(result);
	}
	...
	public String writeStatement(String tableName) {
		...
		while ( en.hasNext() ) {
			...
			if ( tf.fieldName != null && ! tf.fieldName.equals("") ) {
				...
				if ( tf.primaryKey != null && tf.primaryKey.booleanValue() ) { result.append(" PRIMARY KEY"); }
				began = true;
			}
