...
public class TableEditorNodeContext implements IDENodeContextPluginIF {
  ...
  public Action[] getActionsFor(NodeIDEBase[] selectedNodes) {
    ...
    if ( (selectedNodes!= null) && (selectedNodes.length==1)) {
      if ( ! ( selectedNodes[0] instanceof ItemTableNode ) ) return NULL_ACTIONS;
  ...
  class EditTableAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
      ...
      tableEditor.setTableName(tableNode.toString());
